...
$(function() {
	$( "#minimail" ).draggable({ containment: ".interface" });

	$("#ouvrirminimail").click(function(){ // Ouvrir les conseils de sécurité
		$("#minimail").toggle();
	});

	$("#fermerminimail").click(function(){ // Fermer les conseils de sécurité
		$("#minimail").hide();
	});
...
$(function() {
	$( "#gamecenter" ).draggable({ containment: ".interface" });

	$("#ouvrirgamecenter").click(function(){ // Ouvrir le centre de jeu
		$("#gamecenter").toggle();
	});

	$("#fermergamecenter").click(function(){ // Fermer les conseils de sécurité
		$("#gamecenter").hide();
	});
